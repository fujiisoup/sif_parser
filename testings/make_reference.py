...
files = [PUBLIC_DATA_DIR + f for f in 
         os.listdir(PUBLIC_DATA_DIR) if f[-4:].lower() == '.sif']
files += [PRIVATE_DATA_DIR + f for f in 
         os.listdir(PRIVATE_DATA_DIR) if f[-4:].lower() == '.sif']
